<template>
    <div class="bg-white m-4 shadow-md">
        <!-- Слайдер с фотографиями -->
        <div v-if="data.photos && data.photos.length > 0" class="swiper-container">
            <swiper
                :spaceBetween="30"
                :pagination="{
                  clickable: true,
                ...
                class="mySwiper"
            >
                <swiper-slide v-for="photo in data.photos" :key="photo.id">
                    <img :src="'/storage/' + photo.path" :alt="`Фото ${data.brand.name} ${data.model.name}`"
        ...
        <div class="p-4 relative">
            <h2 class="text-3xl text-gray-800 font-light">{{ data.title && data.title.length > 0 ? data.title : data.brand.name + ' ' + data.model.name }}</h2>
            ...
            <div class="mt-2">
                ...
                <div class="flex">
                    ...
                    <span class="text-gray-400">{{ data.engine }}</span>
                </div>
                <!-- Transmission -->
                <div class="flex">
                    ...
                    <span class="text-gray-400">{{ data.transmission }}</span>
                </div>
                <!-- Drive -->
                <div class="flex">
                    ...
                    <span class="text-gray-400">{{ data.drive }}</span>
                </div>
                <!-- Vin -->
                <div class="flex pl-1">
                    ...
                    <span class="text-gray-400">{{ data.vin }}</span>
                </div>
                <!-- Interior -->
                <div v-if="data.interior" class="flex">
